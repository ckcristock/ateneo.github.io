...
// import { MenuItems } from '../auditorias/reporteauditorias/menu-items';
...
export class GeneralService {
  ...
  constructor(
    ...
    this.Ruta_Principal = environment.ruta;
    this.Ruta_Reportes = environment.ruta + 'php/reportes/';
    this.Ruta_Imagenes = environment.ruta + 'IMAGENES/';
  ...
  private GetInfoConfiguracion(): void {
    this.client
      .get(environment.ruta + 'php/actarecepcion/lista_impuesto_mes.php', {
  ...
  public GetNoConformes(): Observable<any> {
    return this.client.get(
      environment.ruta + 'php/actarecepcioninternacional/causal_no_conformes_internacional.php',
    );
  }
  ...
  public GetMunicipiosDepartamento(idDepartamento: string): Observable<any> {
    ...
    return this.client.get(environment.ruta + 'php/genericos/municipios_departamento.php', {
      params: p,
    });
  }
