...
export class RemisionService {
  ...
  getInvoiceDetail(id: number): Observable<any> {
    return this.http.get(`${environment.base_url}/php/facturasventas/detalle_factura_venta.php`, {
      params: { id },
    });
  }
  ...
  getCreditNotes(params?: {}): Observable<any> {
    return this.http.get(
      `${environment.base_url}/php/notas_credito_nuevo/get_nota_credito_por_factura.php`,
      {
        params,
      },
    );
  ...
  downloadPrintInvoice(params: any) {
    const headers = new HttpHeaders().set('Content-Type', 'application/json');
    return this.http.get(`${environment.base_url}/php/facturasventas/descarga_pdf.php`, {
      params,
      headers,
