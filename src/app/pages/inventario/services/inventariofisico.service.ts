...
export class InventariofisicoService {
  ...
  public GetDocumentosParaAjustarAuditables(p: any): Observable<any> {
    return this.client.get(
      environment.base_url + '/php/inventario_auditor/documentos_para_ajustar_auditables.php',
      { params: p },
    );
  }
  ...
  public SaveInventarioFinalEstibaWithToken(data: any): Observable<any> {
    return this.client.post(
      environment.base_url + '/php/inventariofisico/estiba/guardar_inventario_final.php',
      data,
    );
  ...
  public getInventarioAuditableTerminado(p: string): Observable<any> {
    return this.client.get(
      environment.base_url + '/php/inventario_auditor/show_inventario_Terminado.php?Id=' + p,
    );
  }
  public getInventarioFisicoTerminadoPunto(p: string): Observable<any> {
    console.log('id en services', p);
    return this.client.get(
      environment.ruta +
  ...
  public DescargarInformeEstiba(data: any): Observable<any> {
