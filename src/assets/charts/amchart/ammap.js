...
(function () {
  ...
  d.AmDraw = d.Class({
    construct: function (a, b, c, e) {
      ...
      d.hasSVG =
        !!document.createElementNS && !!document.createElementNS(d.SVG_NS, 'svg').createSVGRect;
      1 > b && (b = 10);
      1 > c && (c = 10);
      this.div = a;
      this.width = b;
    ...
    addDefs: function (a) {
      if (d.hasSVG) {
        ...
        d.rtl &&
          (c.setAttribute('direction', 'rtl'), (c.style.left = 'auto'), (c.style.right = '0px'));
        a &&
          (a.addCodeCredits &&
...
(function () {
  ...
  d.SVGRenderer = d.Class({
    ...
    animate: function (a, b, c, e, f) {
      ...
      'translate' == b
        ? ((g = (g = g.getAttribute('transform')) ? String(g).substring(10, g.length - 1) : '0,0'),
          (g = g.split(', ').join(' ')),
          (g = g.split(' ').join(',')),
          0 === g && (g = '0,0'))
    ...
    update: function () {
      ...
      for (a = b.length - 1; 0 <= a; a--) {
        ...
        if (f <= e) {
          ...
          'translate' == h
            ? ((l = c.to.split(',')), (m = Number(l[0])), (l = Number(l[1])), g.translate(m, l))
  ...
  d.AmChart = d.Class({
    ...
    drawLabel: function (a) {
      ...
      if (b.container && !1 !== a.enabled) {
        ...
        'right' == f && (f = 'end');
        'center' == f &&
          ((f = 'middle'), k ? (c = b.realHeight - c + c / 2) : (n = b.realWidth / 2 - n));
        void 0 === l && (l = 1);
        void 0 === k && (k = 0);
        c += g / 2;
    ...
    resetTouchStyle: function () {
      this.panEventsEnabled &&
        this.chartDiv &&
        ((this.chartDiv.style.msTouchAction = 'auto'), (this.chartDiv.style.touchAction = 'auto'));
    },
    ...
    dispDUpd: function () {
      this.skipEvents ||
        (this.dispatchDataUpdated &&
          ((this.dispatchDataUpdated = !1), this.fire({ type: 'dataUpdated', chart: this })),
    ...
    showBalloonReal: function (a, b, c, e, d) {
      ...
      g.enabled &&
        ...
        g.changeColor(b),
        !c || g.fixedPosition
          ? (g.setPosition(e, d), isNaN(e) || isNaN(d) ? g.followCursor(!0) : g.followCursor(!1))
          : g.followCursor(!0),
        a && g.showBalloon(a));
    },
    ...
    handleMouseMove: function (a) {
      ...
      if (a) {
        ...
        this.boundingRect &&
          a.clientX &&
          ((b = a.clientX - this.boundingRect.left), (c = a.clientY - this.boundingRect.top));
        isNaN(e)
          ? (this.mouseX = b)
      ...
      if (this.animations)
        for (a = this.animations.length - 1; 0 <= a; a--) {
          ...
          if (e <= c) {
            ...
            0 === k
              ? (this.animations.splice(a, 1), (f.node.style[g] = Number(b.to) + b.suffix))
  ...
  d.AmBalloon = d.Class({
    ...
    draw: function () {
      ...
      if (!isNaN(a)) {
        ...
        this.set = g;
        this.mainSet
          ? (this.mainSet.push(this.set), (this.sdx = this.mainSet.x), (this.sdy = this.mainSet.y))
              ...
              : ((r = []),
                ...
                'H' != u
                  ? ((h = a - x),
                    ...
                    (w = H ? [0, 0, b - A, 0, 0, v, v, 0] : [v, v, b - A, v, v, 0, 0, v]))
                  : ((u = b - A),
                    u > v - B && (u = v - B),
                    u < B && (u = B),
                ...
                0 < G && ((a = d.polygon(f, r, w, p, 0, q, D, G)), a.translate(1, 1), g.push(a)),
    ...
    hide: function (a) {
      ...
      if (0 < a && !b.isHiding) {
        ...
        b.textDiv &&
          (b.fadeAnim2 = c.animate({ node: b.textDiv }, 'opacity', 1, 0, a, 'easeInSine', ''));
...
(function () {
    ...
    B
      ? (G ||
          (f =
            ...
            ',' +
            q(z)),
        (h = ' M' + q(u) + ',' + q(v) + ' L' + q(A) + ',' + q(C) + f + ' L' + q(F) + ',' + q(w)))
      : (h =
          ' M' +
          u +
          ',' +
  ...
  d.adjustLuminosity = function (a, b) {
    ...
    6 > a.length &&
      (a = String(a[0]) + String(a[0]) + String(a[1]) + String(a[1]) + String(a[2]) + String(a[2]));
    b = b || 0;
    var c = '#',
      e,
      f;
...
(function () {
  ...
  d.AmLegend = d.Class({
    ...
    arrangeEntries: function () {
      ...
      l = w.height + 2 * m - 1;
      'left' == a || 'right' == a
        ? ((n = w.width + 2 * g), (k = n + b + c), (h.style.width = k + 'px'), (this.ieW = k))
        : (n = k - b - c - 1);
      c = d.polygon(
        this.container,
        [0, n, n, 0],
          ...
          if ('line' == e || 'step' == e || 'smoothedLine' == e || 'ohlc' == e)
            (m = p.set()),
              ...
              a.bullet &&
                ...
                (d.setCN(c, r, 'graph-bullet'), r.translate(t + 1, t / 2), m.push(r)),
              (y = 0),
              (r = t),
              (q = t / 3);
          else {
    ...
    createValue: function (a) {
      ...
      if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
        ...
        c = b.container
          .rect(a.legendEntryWidth, 0, g, e, 0, 0)
        ...
        for (c = 0; c < a.length; c++) {
          ...
          if (e) g.value ? f.text(g.value) : f.text('');
            ...
            if (void 0 !== g.type) {
              ...
              k
                ...
                : l &&
                  ...
                  ((l = d.massReplace(l, { '[[title]]': g.title })),
            ...
            g.legendColorFunction &&
              (n = g.legendColorFunction(l, h, g.periodDataItem, g.periodPercentDataItem));
            f.text(h);
            if (
              !g.pattern &&
              (this.useMarkerColorForValues && f.setAttr('fill', n), this.useMarkerColorForLabels)
            ) {
...
(function () {
  ...
  d.AmMap = d.Class({
    ...
    rescaleMapAndObjects: function () {
      ...
      if (this.areasSettings.adjustOutlineThickness) {
        for (var b = this.svgAreas, d = 0; d < b.length; d++)
          (c = b[d]) &&
            c.setAttr('stroke-width', this.areasSettings.outlineThickness / a / this.mapScale);
      ...
      if (d.isModern) {
        ...
        if (!a.preventHover) {
          ...
          ((a.mouseIsOver && !a.mapWasDragged && !a.skipClick) ||
            (a.wasTouched && 3 > Math.abs(a.mouseX - a.tmx) && 3 > Math.abs(a.mouseY - a.tmy))) &&
    ...
    zoomToObject: function (a) {
      if (a) {
        ...
        var e = a.zoomLevel,
          ...
          l = this.realHeight;
        isNaN(e) ||
          (isNaN(b) || isNaN(c) ? this.zoomTo(e, g, h, f) : this.zoomToLongLat(e, c, b, f));
    ...
    zoomTo: function (a, b, c, e) {
      ...
      f = this.zoomLevel();
      isNaN(b) &&
        ((b = this.realWidth / this.mapWidth), (b = (this.zoomX() - 0.5 * b) * (a / f) + 0.5 * b));
      isNaN(c) &&
    ...
    rollOutMapObject: function (a, b) {
      ...
      a &&
        ...
        this.fire({ type: 'rollOutMapObject', mapObject: a, chart: this, event: b }));
    },
    ...
    clickMapObject: function (a, b) {
      var c = this;
      b &&
        (b.touches || (isNaN(a.zoomLevel) && isNaN(a.zoomX) && isNaN(a.zoomY)) || c.hideBalloon());
      if (
        c.chartCreated &&
        !c.preventHover &&
    ...
    x2c: function (a) {
      ...
      return (
        Math.round(
          ((this.unscaledMapWidth * (a - b)) / (this.dataProvider.rightLongitude - b)) * 100,
        ) / 100
      );
    },
    y2c: function (a) {
      ...
      return (
        Math.round(
          ((this.unscaledMapHeight * (a - b)) / (this.dataProvider.bottomLatitude - b)) * 100,
        ) / 100
      );
    },
  ...
  d.ZoomControl = d.Class({
    ...
    update: function () {
      ...
      h &&
        ...
        this.previousDY != g &&
          e &&
          (e.translate((this.buttonSize - this.draggerSize) / 2, g), (this.previousDY = g)));
    },
  });
})();
(function () {
    ...
    init: function (a, b) {
      ...
      if (c.enabled) {
        ...
        var l,
          ...
          p = k / 2;
        a.svgIcons
          ? (n.svgIcon = d.line(b, [-p / 2, 0, p / 2], [-p / 4, p / 4, -p / 4], c.iconColor, 1, 1))
        ...
        a.svgIcons
          ? (t.svgIcon = d.line(b, [-p / 2, 0, p / 2], [p / 4, -p / 4, p / 4], c.iconColor, 1, 1))
  ...
  d.AreasProcessor = d.Class({
    ...
    createArea: function (a) {
      ...
      if (
        ...
        w && !a.title && (a.title = w),
        (c = b.language)
          ? (w = d.mapTranslations) && (c = w[c]) && c[a.enTitle] && (a.titleTr = c[a.enTitle])
          : (a.titleTr = void 0),
        p)
      ) {
        c = a.tabIndex;
    ...
    getCoordinates: function (a, b) {
      ...
      if (!isNaN(a)) {
        ...
        if (1 < this.longitudes.length) {
          ...
          1 < this.x.length &&
            ((c = this.x[b]), (f = this.x[b + 1]), (e = this.y[b]), (g = this.y[b + 1]));
